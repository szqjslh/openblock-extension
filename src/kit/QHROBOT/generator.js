...
function addGenerator (Blockly) {
    ...
    Blockly.Arduino.QH_button_both = function (block) {
        ...
        const code = `digitalRead(QDPport[${pin}][0])||digitalRead(QDPport[${pin}][1])`;
    ...
    Blockly.Arduino.QH_buttonfuction_init = function () {
        const pin = this.getFieldValue('pin');
        Blockly.Arduino.definitions_.define_qdport = '#include <QDPport.h>';
        const code = `buttonP${pin}_0.Update();\nbuttonP${pin}_1.Update();\n`;
        return code;
    };
    // 多功能按钮
    Blockly.Arduino.QH_buttonfuction_do = function () {
        ...
        const code = `buttonP${dropdown_pin}_${dropdown_pin1}.buttoncheck(${dropdown_pin2})`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    //
    // 超声波
    Blockly.Arduino.QH_UltraSonicDistanceSensor = function () {
        ...
        const code = `distanceSensor_${dropdown_pin}.measureDistance${dropdown_pin2}()`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // 巡线
    ...
    Blockly.Arduino.QH_lightSensor = function () {
        const dropdown_pin = this.getFieldValue('PIN');
        Blockly.Arduino.definitions_.define_qdport = '#include <QDPport.h>';
        const code = `analogRead(QDPport[${dropdown_pin}][1])`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // 声音
    Blockly.Arduino.QH_sound = function () {
        const dropdown_pin = this.getFieldValue('PIN');
        Blockly.Arduino.definitions_.define_qdport = '#include <QDPport.h>';
        const code = `analogRead(QDPport[${dropdown_pin}][0])`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // 电位器
    ...
    Blockly.Arduino.QH_Potentiometer = function () {
        ...
        const dropdown_pin1 = this.getFieldValue('PIN1');
        Blockly.Arduino.definitions_.define_qdport = '#include <QDPport.h>';
        const code = `analogRead(QDPport[${dropdown_pin}][${dropdown_pin1}])`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // 摇杆初始化
    ...
    Blockly.Arduino.QH_dht11 = function () {
        ...
        const code = `myDHT_${dropdown_pin}.read${what}()`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // 颜色传感器启用块
    Blockly.Arduino.QH_yssb_init = function () {
        ...
        let code = 'uint16_t r, g, b, c, colorTemp, lux;\ntcs.getRawData(&r, &g, &b, &c);\ncolorTemp = tcs.calculateColorTemperature_dn40(r, g, b, c);\nlux = tcs.calculateLux(r, g, b);\n';
        if (dropdown_pin3 == '1') {
            ...
            const code1 = 'Serial.print("Color Temp: "); Serial.print(colorTemp, DEC); Serial.print(" K - ");\nSerial.print("Lux: "); Serial.print(lux, DEC); Serial.print(" - ");\nSerial.print("R: "); Serial.print(r, DEC); Serial.print(" ");\nSerial.print("G: "); Serial.print(g, DEC); Serial.print(" ");\nSerial.print("B: "); Serial.print(b, DEC); Serial.print(" ");\nSerial.print("C: "); Serial.print(c, DEC); Serial.print(" ");\nSerial.println(" ");\n';
            code = code + code1;
        }
    ...
    Blockly.Arduino.QH_yssb_compare = function () {
        ...
        const code = `${dropdown_pin1} >= (${num1} - ${num2}) && ${dropdown_pin1} <= (${num1} + ${num2})`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // 传感器-MPU6050-更新数据
    ...
    Blockly.Arduino.QH_ledlight = function () {
        ...
        const code = `digitalWrite(QDPport[${dropdown_pin}][${dropdown_pin2}],${dropdown_stat});\n`;
        return code;
    };
    // 读取LED灯状态
    Blockly.Arduino.QH_read_ledlight = function () {
        ...
        const dropdown_pin2 = this.getFieldValue('PIN1');
        Blockly.Arduino.setups_[`setup_output33_${dropdown_pin}${dropdown_pin2}`] = `pinMode(QDPport[${dropdown_pin}][${dropdown_pin2}], OUTPUT);`;
        const code = `digitalRead(QDPport[${dropdown_pin}][${dropdown_pin2}])`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // LED亮度
    Blockly.Arduino.QH_ledlight_PWM = function () {
        ...
        const code = `analogWrite(QDPport[${dropdown_pin}][${dropdown_pin2}],${ledn});\n`;
        return code;
    };
    // 继电器
    ...
    Blockly.Arduino.QH_rgb_led = function () {
        ...
        const pin1 = this.getFieldValue('PIN');
        ...
        const NUM8 = Blockly.Arduino.valueToCode(this, 'num8', Blockly.Arduino.ORDER_ATOMIC) || '0';
        ...
        const code = `QDPRGBLED_${pin1}.setRgbLEDColor(${NUM},${R},${G},${B});\n`;
        return code;
    };
    // 蜂鸣器
    ...
    Blockly.Arduino.QH_buzzer = function (){
        ...
        const code = `QDPBuzzer${dropdown_pin}.tone(QDPport[${dropdown_pin}][1],${dropdown_pin2},${dur});\n`;
        return code;
    };
    // 蜂鸣器音乐
    Blockly.Arduino.QH_buzzer_music = function (){
        ...
        Blockly.Arduino.setups_[`setup_output_${dropdown_pin}`] = '';
        const code = `QDPBuzzer${dropdown_pin}.buzzer_music(QDPport[${dropdown_pin}][1],${dropdown_pin2});\n`;
        return code;
    };
    // 直流电机
    Blockly.Arduino.QH_motor = function () {
        ...
        const code = `QDP${dropdown_pin}.run(${speed});\n`;
        return code;
    };
    // 舵机360
    ...
    Blockly.Arduino.QH_Voice = function () {
        ...
        const PIN = this.getFieldValue('PIN');
        const addr = Blockly.Arduino.valueToCode(this, 'addr', Blockly.Arduino.ORDER_ATOMIC) || '0';
        const delayTime = Blockly.Arduino.valueToCode(this, 'delayTime', Blockly.Arduino.ORDER_ATOMIC) || '0';
        const code = `VoiceSendData(${addr},${PIN});\ndelay(${delayTime});\n`;
        return code;
    };
    // 语音识别发送数据
    Blockly.Arduino.QH_ASR_SendData = function () {
        ...
        const code = `MyASR${dropdown_pin}.SendData(\"${keyword}\");\n`;
        return code;
    };
    // 语音识别接收
    Blockly.Arduino.QH_ASR_ReceiveData = function () {
        ...
        const code = `MyASR${dropdown_pin}.ReceiveData();\n`;
        return code;
    };
    // 语音识别对比数据
    Blockly.Arduino.QH_ASR_CompareData = function () {
        ...
        const keyword = this.getFieldValue('keyword');
        const code = `MyASR${dropdown_pin2}.CompareData(\"${keyword}\")`;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    const json = {
        '00A4': 'A1E8',
    ...
    const encodeToGb2312 = function (str){
        let strOut = '';
    ...
    const utf8ToGb2312Array = function (str){
    ...
    Blockly.Arduino.QH_QF_hc = function () {
        ...
        const dropdown_pin = this.getFieldValue('pinn');
        const dropdown_pin3 = this.getFieldValue('PIN33');
        const dropdown_pin4 = this.getFieldValue('PIN44');
    ...
    Blockly.Arduino.QH_QF_sound = function () {
        ...
        if (dropdown_pin == 5){
            ...
            Blockly.Arduino.definitions_.var_qdprobot_qdpxfhs = 'QDPQF QFYY;\n';
            Blockly.Arduino.setups_.setup_qdprobot_serial = 'Serial.begin(9600);';
            var code = `QFYY.begin(Serial);\nQFYY.HC("[x1]sound${dropdown_pin3}${num}",0);\n`;
        } else {
            Blockly.Arduino.definitions_.define_SoftwareSerial = '#include <SoftwareSerial.h>';
            Blockly.Arduino.definitions_.define_qdpxf = '#include <QDPQF.h>';
            Blockly.Arduino.definitions_.var_qdprobot_qdpxfhs = 'QDPQF QFYY;\n';
    ...
    Blockly.Arduino.QH_QF_startstopsb = function () {
        const dropdown_pin = this.getFieldValue('pinn');
        const dropdown_pin4 = this.getFieldValue('PIN33');
        const num = Blockly.Arduino.valueToCode(this, 'num', Blockly.Arduino.ORDER_ATOMIC) || '0';
        Blockly.Arduino.definitions_.define_qdport = '#include <QDPport.h>';
    ...
    Blockly.Arduino.QH_QF_sbjg = function () {
        const number = Math.ceil(Math.random() * 100000);
        let str1 = Blockly.Arduino.valueToCode(this, 'TEXT', Blockly.Arduino.ORDER_ATOMIC) || 'String(\"\")';
        str1 = str1.replace(/\"/g, '');
        str1 = utf8ToGb2312Array(str1);
        Blockly.Arduino.definitions_[`var_declare_${number}`] = `char Corpus_${number}[] = {${str1},0X00};`;// 定义数组

        const code = `QFYY.DBJG(Corpus_${number})`;
    ...
    Blockly.Arduino.QH_QF_sbjg2 = function () {
        const number = Math.ceil(Math.random() * 100000);
        let dropdown_pin3 = this.getFieldValue('pinn2');
    ...
    Blockly.Arduino.QH_display = function () {
        ...
        const dropdown_pin3 = this.getFieldValue('pinn2');
        const num = Blockly.Arduino.valueToCode(this, 'num', Blockly.Arduino.ORDER_ATOMIC) || '0';
        Blockly.Arduino.definitions_.define_qdport = '#include <QDPport.h>';
    ...
    Blockly.Arduino.oled_init = function () {
        const OLED_TYPE = this.getFieldValue('OLED_TYPE');
        let NAME = Blockly.Arduino.valueToCode(this, 'NAME', Blockly.Arduino.ORDER_ATOMIC) || 'u8g2';
        NAME = NAME.replace(/\"/g, '');
        const ROTATION = this.getFieldValue('ROTATION');
        const SDA = this.getFieldValue('SDA');
        const SCL = this.getFieldValue('SCL');
        let ADDRESS = Blockly.Arduino.valueToCode(this, 'ADDRESS') || '0x3C';
    ...
    Blockly.Arduino.oled_page = function () {
        const NAME = this.getFieldValue('NAME') || 'u8g2';
        const branch = Blockly.Arduino.statementToCode(this, 'DO') || '\n';
        // branch = branch.replace(/(^\s*)|(\s*$)/g, "");
        if (branch) {
            const code = `${NAME}.firstPage();` +
        `\ndo` +
        `\n{` +
        `\n${branch
        }}while(${NAME}.nextPage());\n`;
    ...
    Blockly.Arduino.oled_showBitmap = function () {
        const NAME = this.getFieldValue('NAME') || 'u8g2';
        const start_x = Blockly.Arduino.valueToCode(this, 'START_X') || '0';
        const start_y = Blockly.Arduino.valueToCode(this, 'START_Y') || '0';
        const width = Blockly.Arduino.valueToCode(this, 'WIDTH') || '0';
        const height = Blockly.Arduino.valueToCode(this, 'HEIGHT') || '0';
        let data_name = Blockly.Arduino.valueToCode(this, 'bitmap_name', Blockly.Arduino.ORDER_ATOMIC);
    ...
    // 取模工具设置部分
    const bitArr = new Array();
    for (var i = 0; i < 8; i++)bitArr[i] = (0x80 >> i);// 初始化位数组
    const canvas = document.createElement('canvas');// 创建canvas
    const ctx = canvas.getContext('2d');// 获得内容描述句柄

    Blockly.Arduino.tool_modulus = function () {
        const dropdown_bitmap_formats = this.getFieldValue('bitmap_formats');
        const dropdown_modulus_way = this.getFieldValue('modulus_way');
        const dropdown_modulus_direction = this.getFieldValue('modulus_direction');
        const dropdown_hz_sharp = this.getFieldValue('hz_sharp');

        // var text_hz_line_height = this.getFieldValue('hz_line_height');
        let text_hz_line_height = Blockly.Arduino.valueToCode(this, 'hz_line_height', Blockly.Arduino.ORDER_ATOMIC) || '0';
        text_hz_line_height = text_hz_line_height.replace(/\"/g, '');

        const dropdown_hz_up_down = this.getFieldValue('hz_up_down');
        const text_hz_up_down_data = this.getFieldValue('hz_up_down_data');
        const dropdown_hz_left_right = this.getFieldValue('hz_left_right');
        const text_hz_left_right_data = this.getFieldValue('hz_left_right_data');

        // var text_bitmap_width = this.getFieldValue('bitmap_width');
        // var text_bitmap_height = this.getFieldValue('bitmap_height');
        let text_bitmap_width = Blockly.Arduino.valueToCode(this, 'bitmap_width', Blockly.Arduino.ORDER_ATOMIC) || '0';
        text_bitmap_width = text_bitmap_width.replace(/\"/g, '');
        let text_bitmap_height = Blockly.Arduino.valueToCode(this, 'bitmap_height', Blockly.Arduino.ORDER_ATOMIC) || '0';
        text_bitmap_height = text_bitmap_height.replace(/\"/g, '');


        const angle_bitmap_rotate = 0;
        const checkbox_show_hz = 'TRUE';

        // var text_input_data = this.getFieldValue('input_data');
        let text_input_data = Blockly.Arduino.valueToCode(this, 'input_data', Blockly.Arduino.ORDER_ATOMIC) || '0';
        text_input_data = text_input_data.replace(/\"/g, '');

        const dropdown_hz_variant = 'normal';
        const dropdown_hz_style = 'normal';
        const dropdown_hz_thickness = 'normal';
        const fontSize_width = myAtoi(text_bitmap_width);
        const fontSize_height = myAtoi(text_bitmap_height);
        const bs = Math.ceil(fontSize_width / 8);// 每行占字节数
        ...
        const data = ctx.getImageData(0, 0, fontSize_width, fontSize_height).data;// 获取图像
        const zm = new Array(bs * fontSize_height);
        ...
        let outStr = '';// 将字模数组转化为十六进制形式
        for (var i = 0; i < zm.length - 1; i++)outStr += `${toHex(zm[i])},`;
        outStr += toHex(zm[i]);

        const zm1 = new Array(bs * fontSize_height);
        let outstr1 = '';
        ...
        // 取模走向
        // 顺向(高位在前) - 1,逆向(低位在前) - 2
        let bit_num = fontSize_height * bs;
        let modulus_data = '';
        let array_x = 0;
        let array_y = 0;
        const modulus_y = Math.ceil(fontSize_height / 8);
        const modulus_x = Math.ceil(fontSize_width / 8);
        ...
        if (dropdown_modulus_way == '1') {
            ...
            for (var j = 1; j <= bit_num; j++) {
                for (var i = 1; i <= 8; i++) {
                    ...
                    if (dropdown_bitmap_formats == '1') {
                        modulus_data += modulus_array[array_y][array_x];
                    } else if (modulus_array[array_y][array_x] == '0') {
                        modulus_data += '1';
                    } else {
                        modulus_data += '0';
                    }
        ...
        const code = modulus_data;
        return [code, Blockly.Arduino.ORDER_ATOMIC];
    };
    // 取模工具显示数据部分
    Blockly.Arduino.tool_modulus_show = function () {
        // var varName = Blockly.Arduino.variableDB_.getName(this.getFieldValue('VAR'),Blockly.Variables.NAME_TYPE);
        let varName = Blockly.Arduino.valueToCode(this, 'VAR', Blockly.Arduino.ORDER_ATOMIC);
        varName = varName.replace(/\"/g, '');
        const X = this.getFieldValue('x');
        const checkbox_save_hz = this.getFieldValue('save_hz') == 'TRUE';
        const value_input = Blockly.Arduino.valueToCode(this, 'input_data', Blockly.Arduino.ORDER_ATOMIC);

        let X_1 = 0;
        for (const i of value_input) {
            if (i == ',') {
                X_1++;
            }
        }
    ...
    Blockly.Arduino.u8g2_setContrast = function () {
        let NAME = Blockly.Arduino.valueToCode(this, 'NAME', Blockly.Arduino.ORDER_ATOMIC) || 'u8g2';
        NAME = NAME.replace(/\"/g, '');
        const Contrast = Blockly.Arduino.valueToCode(this, 'Contrast', Blockly.Arduino.ORDER_ATOMIC);
        const code = `${NAME}.setContrast(${Contrast});\n`;
        return code;
    };
    // OLED显示内置图片
    Blockly.Arduino.oled_face = function () {
        let NAME = Blockly.Arduino.valueToCode(this, 'NAME', Blockly.Arduino.ORDER_ATOMIC) || 'u8g2';
        NAME = NAME.replace(/\"/g, '');
        const POS_x = Blockly.Arduino.valueToCode(this, 'POS_X') || '0';
        const POS_y = Blockly.Arduino.valueToCode(this, 'POS_Y') || '0';
        let FACE_IMAGE = this.getFieldValue('FACE_IMAGE');
        const pos = FACE_IMAGE.indexOf(',');
        const varName = `FACE_${FACE_IMAGE.substring(0, pos)}`;
        ...
        const code = `${NAME}.drawXBMP(${POS_x},${POS_y},89,64,${varName});\n`;
        return code;
    };
    // 显示-OLED-画点
    ...
    Blockly.Arduino.oled_drawLine = function () {
        ...
        const start_x = Blockly.Arduino.valueToCode(this, 'START_X') || '0';
        const start_y = Blockly.Arduino.valueToCode(this, 'START_Y') || '0';
        const end_x = Blockly.Arduino.valueToCode(this, 'END_X') || '0';
        const end_y = Blockly.Arduino.valueToCode(this, 'END_Y') || '0';
        let code = '';
    ...
    Blockly.Arduino.oled_draw_Str_Line = function () {
        ...
        const start_x = Blockly.Arduino.valueToCode(this, 'START_X') || '0';
        const start_y = Blockly.Arduino.valueToCode(this, 'START_Y') || '0';
        const length = Blockly.Arduino.valueToCode(this, 'LENGTH') || '0';
        const TYPE = this.getFieldValue('TYPE');
        let code = '';
    ...
    Blockly.Arduino.oled_drawFrame = function () {
        let NAME = Blockly.Arduino.valueToCode(this, 'NAME', Blockly.Arduino.ORDER_ATOMIC) || 'u8g2';
        NAME = NAME.replace(/\"/g, '');
        const D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
        const D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
        const Width = Blockly.Arduino.valueToCode(this, 'WIDTH') || '0';
        const Height = Blockly.Arduino.valueToCode(this, 'HEIGHT') || '0';
        const type = this.getFieldValue('TYPE');
        let code = '';
    ...
    Blockly.Arduino.oled_drawRFrame = function () {
        ...
        const Width = Blockly.Arduino.valueToCode(this, 'WIDTH') || '0';
        const Height = Blockly.Arduino.valueToCode(this, 'HEIGHT') || '0';
        const Rauius = Blockly.Arduino.valueToCode(this, 'RADIUS') || '0';
        const type = this.getFieldValue('TYPE');
        let code = '';
        code = `${NAME}.${type}(${D0_x},`;
        code += `${D0_y},`;
    ...
    Blockly.Arduino.oled_drawCircle = function () {
        ...
        const Rauius = Blockly.Arduino.valueToCode(this, 'RADIUS') || '0';
        const type = this.getFieldValue('TYPE');
        const opt = this.getFieldValue('OPT');
        let code = '';
        code = `${NAME}.${type}(${D0_x},`;
        code += `${D0_y},`;
        code += `${Rauius},${opt}); \n`;
    ...
    Blockly.Arduino.oled_drawEllipse = function () {
        ...
        const D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
        const D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
        const Rauius_X = Blockly.Arduino.valueToCode(this, 'RADIUS_X') || '0';
        const Rauius_Y = Blockly.Arduino.valueToCode(this, 'RADIUS_Y') || '0';
        const type = this.getFieldValue('TYPE');
        const opt = this.getFieldValue('OPT');
        let code = '';
        code = `${NAME}.${type}(${D0_x},`;
    ...
    Blockly.Arduino.oled_drawTriangle = function () {
        ...
        const D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
        const D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
        const D1_x = Blockly.Arduino.valueToCode(this, 'D1_X') || '0';
        const D1_y = Blockly.Arduino.valueToCode(this, 'D1_Y') || '0';
        const D2_x = Blockly.Arduino.valueToCode(this, 'D2_X') || '0';
        const D2_y = Blockly.Arduino.valueToCode(this, 'D2_Y') || '0';
        let code = '';
    ...
    Blockly.Arduino.group_lcd_init2 = function () {
        let varName = Blockly.Arduino.valueToCode(this, 'VAR', Blockly.Arduino.ORDER_ATOMIC) || '0';
        varName = varName.replace(/\"/g, '');
        const TYPE = this.getFieldValue('TYPE');
        const SCL = this.getFieldValue('SCL');
        const SDA = this.getFieldValue('SDA');
        const device = Blockly.Arduino.valueToCode(this, 'device', Blockly.Arduino.ORDER_ATOMIC) || '0x27';
        if (SDA == 'SDA' && SCL == 'SCL') {
            Blockly.Arduino.definitions_.include_Wire = '#include <Wire.h>';
    ...
    Blockly.Arduino.group_lcd_print = function () {
        let varName = Blockly.Arduino.valueToCode(this, 'VAR', Blockly.Arduino.ORDER_ATOMIC) || '0';
        varName = varName.replace(/\"/g, '');
        const str1 = Blockly.Arduino.valueToCode(this, 'TEXT', Blockly.Arduino.ORDER_ATOMIC) || '\"\"';
        const str2 = Blockly.Arduino.valueToCode(this, 'TEXT2', Blockly.Arduino.ORDER_ATOMIC) || '\"\"';

        let code = `${varName}.setCursor(0, 0);\n`;
    ...
    Blockly.Arduino.group_lcd_print2 = function () {
        let varName = Blockly.Arduino.valueToCode(this, 'VAR', Blockly.Arduino.ORDER_ATOMIC) || '0';
        varName = varName.replace(/\"/g, '');
        const str = Blockly.Arduino.valueToCode(this, 'TEXT', Blockly.Arduino.ORDER_ATOMIC) || 'String(\"\")';
        const row = Blockly.Arduino.valueToCode(this, 'row', Blockly.Arduino.ORDER_ATOMIC) || '1';
        const column = Blockly.Arduino.valueToCode(this, 'column', Blockly.Arduino.ORDER_ATOMIC) || '1';
        let code = `${varName}.setCursor(${column}-1, ${row}-1);\n`;
    ...
    Blockly.Arduino.group_lcd_power = function () {
        ...
        const code = `${varName}.${dropdown_stat}();\n`;
        return code;
    };
    // 掌控屏
